      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          ...
          <ul>
            ...
            <li <?php if (get_post_type() === 'campsus')
              echo 'class = "current-menu-item" ' ?>><a
                  href="<?php echo get_post_type_archive_link('campsus'); ?>">Campuses</a></li>
        ...
        <div class="site-header__util">
          <!-- Showing the Login and signup button only if user is not logged in -->
          <?php if (is_user_logged_in()) { ?>
            <!-- Showing the Logout button and avatar of logged in user -->
