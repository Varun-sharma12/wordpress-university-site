...
class MyNotes {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-notes").on("click", ".delete-note", this.deleteNote); //On Delete button click.
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-notes").on("click", ".edit-note", this.editNote.bind(this)); //On Edit button click.
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-notes").on("click", '.update-note', this.updateNote.bind(this)); //On Save button click.
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.submit-note').on("click", this.createNote.bind(this)); //On Save button click.
  }

  //Function call when user click on edit button.
  editNote(e) {
  ...
  //function to make the note editable
  ...
  //Function to make the not readonly.
  ...
  //Function call when user save the note.
  createNote(e) {
    var ourNewPost = {
  ...
  //Function call when user click on delete button.
  deleteNote(e) {
    var thisNote = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents("li");
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      beforeSend: xhr => {
...
class Search {
 ...
 ${results.generalInfo.map(post => {
  ...
  ${results.programs.length ? '<ul className="link-list min-list">' : `<p>No programs matches that search. <a href= "${universityData.root_url}/programs">View all the programs</a></p>`}
 ...
 ${results.professors.map(post => {
  ...
  ${results.campuses.length ? '<ul className="link-list min-list">' : `<p>No Campuses matches that search. <a href= "${universityData.root_url}/campsuses">View all the Campuses</a></p>`}
 ...
 ${results.events.map(post => {
  ...
  addSearchHTML() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").append(searchOverlay);
  }
}
